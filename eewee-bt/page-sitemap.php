...
<?php get_header(); ?>
	...
	<div id="content">
            ...
            <?php wp_reset_query(); ?> 
                ...
                <h2><?php _e('Latest Posts', 'themezee_lang'); ?></h2>
                <ul>
                ...
                <h2><?php _e('Pages', 'themezee_lang'); ?></h2>
                <ul>
                    <?php wp_list_pages('title_li='); ?>
                </ul>
                <hr />
                    
                <h2><?php _e('Categories', 'themezee_lang'); ?></h2>
                <ul>
                    <?php wp_list_categories('title_li=&show_count=1'); ?>
                </ul>
                <hr />
                    
                <h2><?php _e('Archives', 'themezee_lang'); ?></h2>
                <ul>
                    <?php wp_get_archives('show_post_count=true'); ?>
                </ul>
                <hr />
                    
                <h2><?php _e('Posts by Category', 'themezee_lang'); ?></h2>
