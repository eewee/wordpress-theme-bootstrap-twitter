...
/*
    ...
    function themezee_shortcodes_css() {
            wp_register_style('eewee_shortcodes', get_template_directory_uri() . '/includes/shortcodes/shortcodes.css');
            wp_enqueue_style('eewee_shortcodes');
    }
    add_action('wp_enqueue_scripts', 'themezee_shortcodes_css');
*/
    // Include Shortcodes
    locate_template('/includes/shortcodes/google-map/google-map.php', true);
    locate_template('/includes/shortcodes/movie/movie.php', true);
    locate_template('/includes/shortcodes/addthis/addthis.php', true);
